...
const Project = () => {
  ...
  return (
    <main className="h-screen w-screen flex">
      <section className="left relative flex flex-col h-screen min-w-96 max-w-96 bg-slate-300">
          ...
          >
            {messages.map((msg, index) => (
              <div
                ...
                } message flex flex-col p-2 w-fit rounded-md max-w-full break-words`}
              >
